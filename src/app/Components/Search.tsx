...
export default function Search() {
  async function HandTxt(e:React.ChangeEvent<HTMLInputElement>){
    let elem:HTMLInputElement|null=document.querySelector("#CntSrc");
  ...
  const [SearchOut,UpdateSearchList]=useState<ListItem[]>([]);
    return (
